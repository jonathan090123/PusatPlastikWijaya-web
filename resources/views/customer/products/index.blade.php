...
@section('content')
    <div class="container" style="padding: 0.75rem 0.5rem;">
        {{-- Page Header --}}
                    ...
                    <form action="{{ route('products.index') }}" method="GET" id="filterForm">
                        ...
                        <div class="filter-group">
                            ...
                            <select name="sort" onchange="this.form.submit()">
                                ...
                                <option value="harga-rendah" {{ request('sort') == 'harga-rendah' ? 'selected' : '' }}>Harga:
                                    Rendah → Tinggi</option>
                                <option value="harga-tinggi" {{ request('sort') == 'harga-tinggi' ? 'selected' : '' }}>Harga:
                ...
                <div class="catalog-info">
                    ...
                    @if(request('search'))
                        <span class="active-filter">
                            "{{ request('search') }}"
                            <a href="{{ route('products.index', request()->except('search')) }}"><i
                    ...
                    @if(request('diskon') === '1')
                        <span class="active-filter active-filter-diskon">
                            ...
                            <a href="{{ route('products.index', request()->except('diskon')) }}"><i
                                    class="fas fa-times"></i></a>
                        </span>
                    @endif
                </div>
    ...
    <script>
        (function () {
            ...
            function checkOpen() {
                ...
                // On mobile layout (< 769px), start closed even if a filter is active to prevent obstructing the results.
            }
            checkOpen();
